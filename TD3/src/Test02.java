...
public class Test02 {
	public static void main(String[] args) {	  
		...
		TC.println("-- test estEgalA() de Monnaie:\nfalse, true, false\t<-- attendu");
		TC.println(euro.estEgalA(yuan)+ ", " + yuan.estEgalA(yuan2)+ ", " + yuan2.estEgalA(yuan3) + "\t<-- obtenu\n");
		...
		TC.println("-- test estEgalA() de Argent:\ntrue, false, false, true\t<-- attendu");
		TC.println(a1.estEgalA(a2)+ ", " + a1.estEgalA(a3)+ ", " + a2.estEgalA(a4)+ ", " + a4.estEgalA(a5) + "\t<-- obtenu\n");   
	}
}
