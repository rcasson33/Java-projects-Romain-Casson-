...
public class Test6a {
  ...
  /**
   * Effectue n tirages par appels a resultatMatch(j1,j2) et compte le nombre
   * de reponses true, ie "j1 resultat".
   * 
   * @param n
   *          nombre de tirages
   * @param j1
   ...
   * @param j2
   *          numero du joueur 2
   * @return le nombre de fois "j1 resultat".
   */
  public static int comptage(int n, int j1, int j2) {
    int cpt = 0;
    for (int i = 0; i < n; i++)
      if (Tournoi.resultatMatch(j1, j2) == 'G')
        cpt = cpt + 1;
    return cpt;
  }

  public static void main(String[] args) {
    if (Tournoi.resultatMatch(0, 10) == 'P') {
