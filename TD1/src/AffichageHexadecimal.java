...
public class AffichageHexadecimal {
  ...
  public static boolean allumeSegment(int segment, int chiffre) {
    if ( segment == 0 ) {
        return chiffre == 0 || chiffre == 2 || chiffre == 3 || chiffre >= 5 && chiffre <= 10 || chiffre == 12 || chiffre >= 14 && chiffre <= 15; 
    }
    if ( segment == 1 ) {
        return chiffre <= 4 || chiffre >= 7 && chiffre <= 10 || chiffre == 13;
    }
    if ( segment == 2 ) {
        return chiffre <= 1 || chiffre >= 3 && chiffre <= 11 || chiffre == 13;
    }
    if ( segment == 3 ) {
        return chiffre == 0 || chiffre == 2 || chiffre == 3 || chiffre == 5 || chiffre == 6 || chiffre == 8 || chiffre == 9 || chiffre >= 11 && chiffre <= 14; 
    }
    if ( segment == 4 ) {
        return chiffre == 0 || chiffre == 2 || chiffre == 6 || chiffre == 8 || chiffre >= 10 && chiffre <= 15; 
    }
    if ( segment == 5 ) {
        return chiffre == 0 || chiffre >= 4 && chiffre <= 6 || chiffre >= 8 && chiffre <= 12 || chiffre >= 14 && chiffre <= 15; 
    }
    if ( segment == 6 ) {
        return chiffre >= 2 && chiffre <=6 || chiffre >= 8 && chiffre <= 11 || chiffre >= 13 && chiffre <= 15 ;
    }
