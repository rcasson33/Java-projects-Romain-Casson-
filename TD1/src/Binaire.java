...
public class Binaire {
  ...
  public static int b1(int n) {
    return (n / 2) % 2; // MODIFIER pour la valeur de retour correcte
  }

  public static int b2(int n) {
    return (n / 4) % 2; // MODIFIER pour la valeur de retour correcte
  }

  public static int b3(int n) {
    return (n / 8)% 2; // MODIFIER pour la valeur de retour correcte
  }
