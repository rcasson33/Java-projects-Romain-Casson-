...
public class TestFibonacci {
	...
	/**
	 * Evalue les performances d'une implantation donnée pour le calcul de F(n) (exo
	 * 3)
	 */
	public static void evaluePerformances(Fibonacci algo, int n) {
		...
		int n1 = s1.length();
		if (n1 > 50)
			s1 = s1.substring(0, 30) + "... (" + (n1 - 30) + " chiffres non affichés)";
		System.out.println();
		System.out.printf("F(%d)= %s%n", n, s1, algo.operations());
		System.out.printf("%s : %d ops, %d ms%n", algo.name(), algo.operations(),
